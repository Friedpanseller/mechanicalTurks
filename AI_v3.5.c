...
#define NEED_MMONEY_FOR_GO8 				((GET_MMONEY == 2) && (GET_MJ >= 2) && (GET_CAMPUS >= 1))
#define RT_MJ_MMONEY_FOR_GO8 				((GET_MMONEY == 2) && (GET_MJ >= 5) && (GET_CAMPUS >= 1))
...
#define NEED_MJ_FOR_GO8 					((GET_MJ == 1) && (GET_MMONEY >= 3) && (GET_CAMPUS >= 1))
#define RT_MMONEY_MJ_FOR_GO8 				((GET_MJ == 1) && (GET_MMONEY >= 6) && (GET_CAMPUS >= 1))
