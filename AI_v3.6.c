...
#define GET_ARC								(getARCs (g, getWhoseTurn(g)))
...
#define NEED_MMONEY_FOR_GO8 				((GET_MMONEY == 2) && (GET_MJ >= 2) && (GET_CAMPUS >= 1) && (GET_ARC <= 7))
#define RT_MJ_MMONEY_FOR_GO8 				((GET_MMONEY == 2) && (GET_MJ >= 5) && (GET_CAMPUS >= 1) && (GET_ARC <= 7))
...
#define NEED_MJ_FOR_GO8 					((GET_MJ == 1) && (GET_MMONEY >= 3) && (GET_CAMPUS >= 1) && (GET_ARC <= 7))
#define RT_MMONEY_MJ_FOR_GO8 				((GET_MJ == 1) && (GET_MMONEY >= 6) && (GET_CAMPUS >= 1) && (GET_ARC <= 7))
#define NEED_MJ_FOR_CAMPUS 				((GET_MJ == 0) && (GET_BPS >= 1) && (GET_BQN >= 1) && (GET_MTV >= 1))
#define RT_MTV_MJ_FOR_CAMPUS 				((GET_MJ == 0) && (GET_BPS >= 1) && (GET_BQN >= 1) && (GET_MTV >= 4))
#define RT_BPS_MJ_FOR_CAMPUS 				((GET_MJ == 0) && (GET_BPS >= 4) && (GET_BQN >= 1) && (GET_MTV >= 1))
#define RT_BQN_MJ_FOR_CAMPUS 				((GET_MJ == 0) && (GET_BPS >= 1) && (GET_BQN >= 4) && (GET_MTV >= 1))
...
#define NEED_BPS_FOR_CAMPUS 				((GET_BPS == 0) && (GET_BQN >= 1) && (GET_MJ >= 1) && (GET_MTV >= 1))
#define RT_MTV_BPS_FOR_CAMPUS 			((GET_BPS == 0) && (GET_BQN >= 1) && (GET_MJ >= 1) && (GET_MTV >= 4))
#define RT_MJ_BPS_FOR_CAMPUS 				((GET_BPS == 0) && (GET_BQN >= 1) && (GET_MJ >= 4) && (GET_MTV >= 1))
#define RT_BQN_BPS_FOR_CAMPUS 			((GET_BPS == 0) && (GET_BQN >= 4) && (GET_MJ >= 1) && (GET_MTV >= 1))
#define NEED_BPS_FOR_ARC 					((GET_BPS == 0) && (GET_BQN >= 1))
#define RT_BQN_BPS_FOR_ARC 				((GET_BPS == 0) && (GET_BQN >= 4))

// BQN - 1x Campus, 1x ARC
#define NEED_BQN_FOR_CAMPUS 				(GET_BQN == 0 && GET_BPS >= 1 && GET_MJ >= 1 && GET_MTV >= 1)
#define RT_MTV_BQN_FOR_CAMPUS 			(GET_BQN == 0 && GET_BPS >= 1 && GET_MJ >= 1 && GET_MTV >= 4)
#define RT_MJ_BQN_FOR_CAMPUS 				(GET_BQN == 0 && GET_BPS >= 1 && GET_MJ >= 4 && GET_MTV >= 1)
#define RT_BPS_BQN_FOR_CAMPUS 			(GET_BQN == 0 && GET_BPS >= 4 && GET_MJ >= 1 && GET_MTV >= 1)
#define NEED_BQN_FOR_ARC 					(GET_BQN == 0 && GET_BPS >= 1)
#define RT_BPS_BQN_FOR_ARC 				(GET_BQN == 0 && GET_BPS >= 4)

// MTV - 1x Campus, 1x Spinoff
#define NEED_MTV_FOR_CAMPUS 				(GET_MTV == 0 && GET_BQN >= 1 && GET_BPS >= 1 && GET_MJ >= 1)
#define RT_MJ_MTV_FOR_CAMPUS 				(GET_MTV == 0 && GET_BQN >= 1 && GET_BPS >= 1 && GET_MJ >= 4)
#define RT_BPS_MTV_FOR_CAMPUS 			(GET_MTV == 0 && GET_BQN >= 1 && GET_BPS >= 4 && GET_MJ >= 1)
#define RT_BQN_MTV_FOR_CAMPUS 			(GET_MTV == 0 && GET_BQN >= 4 && GET_BPS >= 1 && GET_MJ >= 1)
